...
- **changelog** - update `CHANGELOG.md` with entries for the changes.
  ...
  files under `hello_world_efi/`, `src/`,
...
For example, if a commit contains `hello_world_efi/src/main.cpp`, and `CHANGELOG.md`, the component
...
- Header file `include/hello_world_efi/util.h` → `util:`.
